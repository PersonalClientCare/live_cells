...
@GenerateCellWidgets([
  WidgetSpec<Checkbox>(
      ...
      documentation:
          '''A [Checkbox] widget with the [value] controlled by a [MutableCell].
...
'''),
  WidgetSpec<CheckboxMenuButton>(
      ...
      propertyValues: {
        #onChanged: 'enabled() ? (v) => value.value = v : null',
        #onHover:
            'onHover != null ? (v) => _onHoverCell(context).value = v : null',
        #onFocusChange:
            'onFocusChange != null ? (v) => _onFocusChangeCell(context).value = v : null',
      },
      ...
      addProperties: [
        ...
        WidgetPropertySpec<bool>(
            ...
            meta: true,
            documentation:
                'MetaCell for a cell that is updated whenever the hover state of the button changes.'),
        WidgetPropertySpec<bool>(
            name: #onFocusChange,
            defaultValue: null,
            optional: true,
            meta: true,
            documentation:
                'MetaCell for a cell that is updated whenever the focus state of the button changes.')
      ],
      documentation:
...
See [LiveCheckbox] for a more detailed explanation.'''),
  WidgetSpec<CheckedPopupMenuItem>(
      ...
      documentation:
          '''A [CheckedPopupMenuItem] widget with the [value] controlled by a [MutableCell].
...
'''),
  WidgetSpec<ChoiceChip>(
      ...
      documentation:
          '''A [ChoiceChip] widget with the value of [selected] controlled by a [ValueCell].
...
'''),
  WidgetSpec<FloatingActionButton>(
      ...
      excludeProperties: [#onPressed],
      propertyDefaultValues: {#heroTag: 'null'},
      propertyValues: {
        #onPressed: 'enabled() ? press?.trigger : null',
      },
...
'''),
  WidgetSpec<IconButton>(
      as: #LiveIconButton,
      excludeProperties: [#onHover, #onPressed, #onLongPress],
      addProperties: [
        WidgetPropertySpec<bool>(
            name: #enabled,
            defaultValue: 'true',
  ...
  WidgetSpec<InkWell>(
      ...
      addProperties: [
        WidgetPropertySpec<bool>(
            ...
            documentation: 'Is the widget enabled for user input?'),
        WidgetPropertySpec<void>(
            name: #tap, defaultValue: null, optional: true, mutable: true),
        WidgetPropertySpec<void>(
            name: #doubleTap,
            defaultValue: null,
            optional: true,
        ...
        WidgetPropertySpec<TapDownDetails>(
            name: #tapDown, defaultValue: null, optional: true, meta: true),
        WidgetPropertySpec<TapUpDetails>(
            name: #tapUp, defaultValue: null, optional: true, meta: true),
        WidgetPropertySpec<void>(
            name: #secondaryTap,
            defaultValue: null,
            optional: true,
        ...
        WidgetPropertySpec<TapUpDetails>(
            ...
            meta: true),
        WidgetPropertySpec<bool>(
            name: #highlighted, defaultValue: null, optional: true, meta: true),
        WidgetPropertySpec<bool>(
            name: #hovered, defaultValue: null, optional: true, meta: true),
        WidgetPropertySpec<bool>(
            name: #focussed, defaultValue: null, optional: true, meta: true),
      ],
      propertyValues: {
        ...
        #onLongPress: 'enabled() ? longPress?.trigger : null',
        #onTapDown:
            'tapDown != null ? (v) => _tapDownCell(context).value = v : null',
        ...
        #onSecondaryTapDown:
            'secondaryTapDown != null ? (v) => _secondaryTapDownCell(context).value = v : null',
        #onSecondaryTapUp:
            'secondaryTapUp != null ? (v) => _secondaryTapUpCell(context).value = v : null',
        #onSecondaryTapCancel: 'enabled() ? secondaryTapCancel?.trigger : null',
        #onHighlight:
            'highlighted != null ? (v) => _highlightedCell(context).value = v : null',
        #onHover:
            'hovered != null ? (v) => _hoveredCell(context).value = v : null',
        #onFocusChange:
            'focussed != null ? (v) => _focussedCell(context).value = v : null',
      },
...
'''),
  WidgetSpec<InkResponse>(
      ...
      buildMethod: #_buildWrappedWidget,
      documentation:
          '''An [InkResponse] that triggers [ActionCell]s on gestures.
...
'''),
  WidgetSpec<InteractiveViewer>(
      ...
      documentation:
          '''An [InteractiveViewer] where the [transformation] is exposed as a cell.
...
'''),
  WidgetSpec<Slider>(
      ...
      documentation:
          '''A [Slider] with its [value] controlled by a [MutableCell].
...
'''),
  WidgetSpec<Switch>(
      ...
      documentation:
          '''A [Switch] widget with its [value] controlled by a [ValueCell].
